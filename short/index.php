            ...
            if (isset($_POST['g-recaptcha-response']) && !empty($_POST['g-recaptcha-response'])) {
                ...
                if ($responseData->success) {
                    ...
                    if (substr($origin, 0, 7) == "http://" or substr($origin, 0, 8) == "https://") {
                        ...
                        mysqli_query($sql, "insert url values('" . $origin . "','" . $short . "'," . $times . ",'" . $ip . "','" . $date . "','" . $time . "','" . $pass . "')");
                    ...
                    echo("<script language=\"JavaScript\">alert(\"验证码校验失败！\");</script>");
                }

            } else {
                echo("<script language=\"JavaScript\">alert(\"请点击验证码！\");</script>");
            }
        }
        eof:
        ?>
